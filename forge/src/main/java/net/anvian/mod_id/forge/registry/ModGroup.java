...
@Mod.EventBusSubscriber(modid = ModNameToolsMod.MOD_ID, bus = Mod.EventBusSubscriber.Bus.MOD)
public class ModGroup {
    private ModGroup() {
    }

    public static final DeferredRegister<CreativeModeTab> TABS = DeferredRegister.create(Registries.CREATIVE_MODE_TAB, ModNameToolsMod.MOD_ID);
